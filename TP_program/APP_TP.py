...
class TemperaturnaPolja(QMainWindow,Ui_MainWindow):
    ...
    def Tzadatak_vrijeme_E(self,d,U,eta,v,I,T0,T0_1,T0_2,T0_3,T0_4,y1,y2,y3,rez_x,rez_y,Thl1,Thl2,Thl3,Thl4,rho,cp,la):
        ...
        fig.update_layout(height=580, width=800, title_text="t85"+"=f(E,T0) s parametarskom vrijednošću T0")
        ...
        with a.html(lang="pl"):
            ...
            with a.body():
                ...
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"t85_T01= {round(t85_T1,2)}[s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"t85_T02= {round(t85_T2,2)}[s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"t85_T03= {round(t85_T3,2)}[s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"t85_T04= {round(t85_T4,2)}[s]")
    ...
    def Tzadatak_brzina_hl(self,d,U,eta,v,I,T0,T0_1,T0_2,T0_3,T0_4,y1,y2,y3,rez_x,rez_y,Thl1,Thl2,Thl3,Thl4,rho,cp,la):      
        ...
        dTdt_Thl1 = - 2 * np.pi * la * rho * c * ( ( d**2 * ( Thl1 - T0 )**3 ) / ( q / v )**2 )
        dTdt_Thl2 = - 2 * np.pi * la * rho * c * ( ( d**2 * ( Thl2 - T0 )**3 ) / ( q / v )**2 )
        dTdt_Thl3 = - 2 * np.pi * la * rho * c * ( ( d**2 * ( Thl3 - T0 )**3 ) / ( q / v )**2 )
        dTdt_Thl4 = - 2 * np.pi * la * rho * c * ( ( d**2 * ( Thl4 - T0 )**3 ) / ( q / v )**2 )
        ...
        with a.html(lang="pl"):
            ...
            with a.body():
                ...
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"dTdt_Thl1= {round(dTdt_Thl1,2)}[°C/s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"dTdt_Thl2= {round(dTdt_Thl2,2)}[°C/s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"dTdt_Thl3= {round(dTdt_Thl3,2)}[°C/s]")
                with a.h2(id="id23345225", kclass='main_header'):
                    a(f"dTdt_Thl4= {round(dTdt_Thl4,2)}[°C/s]")
    ...
    def Tzadatak_ciklus(self,d,U,eta,v,I,T0,T0_1,T0_2,T0_3,T0_4,y1,y2,y3,rez_x,rez_y,Thl1,Thl2,Thl3,Thl4,rho,cp,la):
        ...
        fig = make_subplots(rows=2, cols=2,subplot_titles=(f"T01:{T0_1}[°C]", f"T02:{T0_2}[°C]", f"T03:{T0_3}[°C]", f"T04:{T0_4}[°C]"))
        ...
        fig.add_trace(go.Scatter(x=tau, y=T2y3,
                            ...
                            name=f'y03={y3}[m]'),
                              row=1, col=2)
        fig.add_trace(go.Scatter(x=tau, y=T3y1,
                            mode='lines',
                            name=f'y01={y1}[m]'),
                              row=2, col=1)
        fig.add_trace(go.Scatter(x=tau, y=T3y2,
                            mode='lines',
                            name=f'y02={y2}[m]'),
                              row=2, col=1)
        fig.add_trace(go.Scatter(x=tau, y=T3y3,
                            mode='lines',
                            name=f'y03={y3}[m]'),
                              row=2, col=1)
        fig.add_trace(go.Scatter(x=tau, y=T4y1,
                            mode='lines',
                            name=f'y01={y1}[m]'),
                              row=2, col=2)
        fig.add_trace(go.Scatter(x=tau, y=T4y2,
                            mode='lines',
                            name=f'y02={y2}[m]'),
                              row=2, col=2)
        fig.add_trace(go.Scatter(x=tau, y=T4y3,
                            mode='lines',
                            name=f'y03={y3}[m]'),
                              row=2, col=2)
...
#U+03C4
    ...
    def Dzadatak_2D_x(self,talj,d,q,roc,v,la,a,y1,y2,y3,y4):
        ...
        fig.update_layout(height=650, width=800, title_text=u"\u03d1"+"=f(x,y) s parametarskom vrijednošću y")
        fig.update_layout(margin=dict(l=0, r=0, t=80, b=0))
    ...
    def Dzadatak_2D_y(self,talj,d,q,roc,v,la,a,x1,x2,x3,x4):
        ...
        fig.update_layout(height=650, width=800, title_text=u"\u03d1"+"=f(x,y) s parametarskom vrijednošću x")
        fig.update_layout(margin=dict(l=0, r=0, t=80, b=0))
    ...
    def zadatak_2D_v(self,v,q,talj,la,a,z1,z2,v0,v1,v2):
        ...
        fig.update_layout(height=650, width=800, title_text=u"\u03d1"+"=f(x,v) s parametarskom vrijednošću v za y=0.015[m]")
        fig.update_layout(margin=dict(l=0, r=0, t=80, b=0))
        fig.update_xaxes(title_text="X [m]", row=1, col=1)
        fig.update_xaxes(title_text="X [m]", row=1, col=2)
        fig.update_yaxes(title_text="Temperatura [°C]", row=1, col=1)
